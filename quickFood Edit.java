// READ MY MESSAGE TO THE REVIEWER BECAUSE JAYSON OBVIOUSLY DIDN'T!!!!!!
...
public class quickFood {
	...
	String[] locationOfDriver = new String[]
		{"Cape Town",
			"Durban",
			"Johannesburg",
			"Potchefstroom",
	...
	//Individual questions for customer
	...
	String pizzaOrdered = customerInfo.nextLine();
	
	//How many pizzas 
	System.out.println("How many " + pizzaOrdered + " would you like: ");
	...
	int pizzaItem = Integer.parseInt(pizzaOrdered);
	...
	//if location does not match locationOfDriver, print "We do not deliver to your area"
	if (Arrays.toString(locationOfDriver).contains(toSearch)){
	    System.out.println("We can help you");
